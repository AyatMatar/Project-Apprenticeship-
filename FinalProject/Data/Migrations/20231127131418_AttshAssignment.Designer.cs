...
namespace FinalProject.Data.Migrations
{
    ...
    [Migration("20231127131418_AttshAssignment")]
    partial class AttshAssignment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject.Data.Entites.attachfileAssignment", b =>
                {
                    b.Property<int>("attachfileId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("attachfileId", "assignmentId");

                    b.HasIndex("assignmentId");

                    b.ToTable("attachAssignments");
                });

            modelBuilder.Entity("FinalProject.Data.Entites.attachfileReport", b =>
                {
                    b.Property<int>("attachfileId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("attachfileId", "reportId");

                    b.HasIndex("reportId");

                    b.ToTable("attachfileReports");
                });
            ...
            modelBuilder.Entity("FinalProject.Data.Entites.attachfileAssignment", b =>
                {
                    b.HasOne("FinalProject.Data.Entites.Assignment", "assignment")
                        .WithMany("attachAssignment")
                        .HasForeignKey("assignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalProject.Data.Entites.Attachfile", "attachfile")
                        .WithMany()
